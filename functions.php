...
function new_base_scripts() {
	...
	wp_enqueue_style( 'new-base-style', get_stylesheet_directory_uri().'/library/css/style.css?v=1.0', array(), _S_VERSION );
	...
	wp_enqueue_script( 'new-base-scripts', get_template_directory_uri() . '/js/scripts.js?v=1.0', array('jquery'), _S_VERSION, true );
